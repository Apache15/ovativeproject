...
export default function BiPretest(){
  ...
  const [actualData, setActualData] = useState({desiredLift: 42.86, convRateControl: 3.5, trafficControl: 50, trafficVariant: 50, trafficRatio: 1});
    ...
    return(
      <div>
      {/* <div class="Button">
        <Button sx={{ ml: "7vh", mt: "1vh", mb: "1vh", width: "12vw" }} className="changeDetail" variant="contained" onClick={changeDetail}>Toggle Tooltips</Button>
      </div> */}
        <div class="BodyContainers">
          <Box class="InputBox">
            <div class="BoxLabel">Inputs</div>
              <Tooltip title={formData.hidden === false ? "The desired percent increase in metric for users receiving the variant versus the control group" : ""} placement="right" arrow>
              ...
              <Tooltip title={formData.hidden === false ? "The current conversion rate of successful actions taken divided by the number of visitors to the page" : ""} placement="right" arrow> 
              ...
              <Tooltip title={formData.hidden === false ? "The percentage of the total sample size that will use the control rather than the variant" : ""} placement="right" arrow>
              ...
              <Tooltip title={formData.hidden === false ? "The percentage of the total sample size that will use the variant rather than the control" : ""} placement="right" arrow>
              ...
              <Tooltip title={formData.hidden === false ? "Suggested value range is 80% - 95%" : ""} placement="right" arrow>
                <Slider name="confLevel" aria-label="Confidence Level" value={formData.confLevel} valueLabelDisplay="auto" label='Confidence Level'
                  step={1} marks min={80} max={99} onChange={processField5Change}/>
              </Tooltip>
                <Typography>Statistical Power</Typography>
                <Tooltip title={formData.hidden === false ? "Statistical Power is typically 80%" : ""} placement="right" arrow>
                  <Slider name="statPower" aria-label="Statistical Power" value={formData.statPower} valueLabelDisplay="auto" label='Confidence Level'
                    step={1} marks min={80} max={99} onChange={processField6Change}/>
                </Tooltip>
                <Tooltip title={formData.hidden === false ? "The positive number of daily visitors participating in either the control or the variant group" : ""} placement="right" arrow>
          ...
          <Box class="OutputBox">
            ...
            <Tooltip title={formData.hidden === false ? "The conversion rate for the variant group required to meet the desired lift of the baseline conversion rate" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The % of traffic in the control group divided by the % of traffic in the variant group" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The sample size required for the variant group, rounded up" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The sample size required for the control group, rounded up" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The variant sample size plus the control sample size" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The number of days the test will take to run, rounded up" : ""} placement="left" arrow>
            ...
            <Tooltip title={formData.hidden === false ? "The number of weeks the test will take to run, rounded up" : ""} placement="left" arrow>
