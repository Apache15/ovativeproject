...
export default class BiPretest extends React.Component {
  constructor(props) {
    ...
    this.state = {
      hidden: false, desiredLift: 42.86, displayedDesiredLift: 42.86, convRateControl: 3.5, displayedConvRateControl: 3.5, convRateVariant: 5, displayedConvRateVariant: 5,
  ...
  processField3Change(inputElement) {
    ...
    this.setState({
      trafficControl: newCont, displayedTrafficControl: newCont, trafficVariant: newVar, displayedTrafficVariant: newVar,
  ...
  processField4Change(inputElement) {
    ...
    var newCont = Math.round(100 * (1 - (.01 * newVar)) * 100) / 100;
    this.setState({
      trafficVariant: newVar, trafficControl: newCont, displayedTrafficVariant: newVar, displayedTrafficControl: newCont,
